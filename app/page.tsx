    ...
    <div className="font-sans text-gray-800">
      ...
      <header className="sticky top-0 z-50 bg-white ">
        ...
        <nav className="hidden md:flex gap-6 text-gray-700 font-medium">
          ...
          <a href="#industries" className="hover:text-orange-500">Industries</a>
          <a href="#clients" className="hover:text-orange-500">Clients</a>
          <a href="#infrastructure" className="hover:text-orange-500">Infrastructure</a>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div className="text-center md:text-left">
            ...
            <p className="text-lg md:text-xl mb-8">
              Comprehensive 3D printing and vacuum casting services — including SLS, SLA, and painting — all managed in-house to deliver industrial precision and consistent quality.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              <Button size="lg" onClick={() => scrollToSection("contact")} className="bg-orange-500 hover:bg-orange-600 text-white font-semibold">
                Talk to an Expert
              </Button>
          ...
          <div className="bg-white text-gray-900 rounded-xl shadow-lg p-8">
            <h2 className="text-3xl font-bold mb-2">Struggling with 3D Print Quality or Delays?</h2>
      ...
      <section id="why" className="py-16 px-6 text-center bg-gray-50">
        ...
        <div className="grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
          {[
            ...
            { icon: Target, title: "Industrial-Grade Material & Precision", desc: "Professional FDM, SLA & SLS printers for complex geometries." },
      ...
      {/* Clients Section */}
      <section id="clients" className="py-16 px-6 bg-gray-50 text-center">
      ...
      <section id="infrastructure" className="py-16 px-6 text-center">
        ...
        <p className="max-w-3xl mx-auto text-gray-600 mb-10">
          Our advanced production facility is equipped with industrial-grade SLA, Vacuum Casting, and SLS 3D printers, Post Processing & Painting, and dedicated QA lab to ensure exceptional part quality.
        </p>
      ...
      <section className="py-16 px-6 text-center">
        ...
        <div className="mt-12">
          ...
          <div className="flex justify-center gap-4">
            ...
            <Button size="lg" variant="outline">Call +91 9899077736</Button>
          </div>
        </div>
      </section>
